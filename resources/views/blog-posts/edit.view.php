...
<form class="w-full max-w-4xl h-screen mx-auto"  method="POST" action="/home/feed/update">

    <h2 class="mt-10 text-center text-3xl font-bold leading-9 tracking-tight text-gray-300">Update blog post</h2>
    ...
    <div class="mt-6 flex items-center justify-end gap-x-6">
        ...
        <button type="submit" class="rounded-md bg-[#2b5876] px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Update</button>
    </div>
</form>
